...
<html lang="en">
    <head>
        ...
        <title>Rakib_Portfolio</title>
        <link href="{{asset('css/adminDash_style.css')}}" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    </head>
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Admin ControlBoard</a>
            <!-- Sidebar Toggle-->
        ...
        <script src="{{asset('js/adminDash_js.js')}}"></script>
    </body>
</html>
